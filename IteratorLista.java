...
/**
* @class Iterator.java 
* @brief Implementacion de Clase para el manejo de Iteradores en una Lista Circular Doble Enlazada<T> </br>
* con nodo cabecera
...
public class IteratorLista<T> implements Iterator<T>{
    ...
    private Nodo<T> posicion;//!<Nodo de la Lista a Iterar   
    
    /**
     * @brief Constructor con parametros de la clase <br>
    ...
    /**
     * @brief Metodo que informa si existe otro elemento en la lista para seguir iterando<br>
    ...
    /**
     * @brief Metodo que retorna un dato de la posición actual del cursor del iterador.<br>
