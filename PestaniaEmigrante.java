...
public class PestaniaEmigrante{
    ...
    // Lista<Emigrante> control.getListaEmigrante();   //lista    
    // Lista<Emigrante> control.getListaGeneralEmigrante();   //lista    
    ...
    private void inicializarRegistroEmigrante(){
        ...
        // control.getListaGeneralEmigrante() = new Lista<Emigrante>();

        // serListEmigrante = new SerializableGenerico<Lista>(fileEmigrantes,listaEmigrante);
        // serListGnrlEmigrante = new SerializableGenerico<Lista>(fileGnrlEmigrantes,control.getListaGeneralEmigrante());
        ...
        // // control.getListaGeneralEmigrante() = deserListGnrlEmigrante.deserialize();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(validarFormulario()){
            guardar();
            // control.setSerListEmigrante().serialize();        
        }else{
    ...
    private void btnEmigrarActionPerformed(java.awt.event.ActionEvent evt) {
        if (validarFormulario()) {
            emigrar();
            // control.setSerListGnrlEmigrante().serialize();
