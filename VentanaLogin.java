...
public class VentanaLogin extends JDialog implements ActionListener{
    ...
    private void initComponents() {
        ...
        tituloLogin.setBounds(10, 0, 480, 60);
        ...
        imagen.setBounds(10, 70, 480, 200);

        labelUser.setText("Usuario");
        panelLogin.add(labelUser);
        labelUser.setBounds(10, 300, 80, 80);

        labelPass.setText("Password");
        panelLogin.add(labelPass);
        labelPass.setBounds(10, 380, 80, 14);
        labelPass.setVisible(false);

        botonAceptar.setText("Aceptar");
        panelLogin.add(botonAceptar);
        botonAceptar.setBounds(150, 400, 110, 30);
        ...
        comboUsuarios.setBounds(70, 330, 190, 20);
        comboUsuarios.addActionListener(this);
        
        panelLogin.add(campoPass);
        campoPass.setBounds(70, 380, 190, 20);
        campoPass.setVisible(false);

        getContentPane().add(panelLogin);
        panelLogin.setBounds(0, 0, 500, 600);
	...
	public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource()==botonAceptar) {
            System.out.println("btonPreciionado");
            String resp = control.validarIngreso(comboUsuarios.getSelectedIndex(),campoPass.getText());
